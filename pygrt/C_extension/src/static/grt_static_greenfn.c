...
"    Compute static Green's Functions and write them to one nc file. \n"
...
"\n"
"    Set -R for a 1D distance list (the usual way to build a GF library).\n"
"    It is stored as nnorth=1, norths=[0], easts=R.\n"
"    Alternatively, set both -X and -Y (north/east) for an explicit 2D\n"
"    grid. This is mainly useful for accuracy tests, or when static_syn\n"
"    should use the same grid directly without distance-based combination\n"
"    of multiple synthesized results.\n"
"    The kernel still depends only on r=sqrt(north^2+east^2); north/east\n"
"    dimensions are retained in the NetCDF file for compatibility.\n"
"\n\n"
"Options:\n"
"----------------------------------------------------------------\n"
...
"                 + <r1>,<r2>[,...]: separated by comma (strictly ascending).\n"
...
"                 ignored when either depth has multiple values.\n"
"\n"
