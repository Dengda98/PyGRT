...
dy=0.15
# 输出到标准输出，重定向到grn文件中
grt static greenfn -Mmilrow -D${depsrc}/${deprcv} -X$x1/$x2/$dx -Y$y1/$y2/$dy > grn
# END GRN
# ---------------------------------------------------------------------------------
...
# BEGIN SYN EXP
# 从标准输入中读取格林函数
grt static syn -S1e24 -N < grn > syn_ex
# END SYN EXP
# ---------------------------------------------------------------------------------
...
# BEGIN SYN SF
# 从标准输入中读取格林函数
grt static syn -S1e16 -F1/-0.5/2 -N < grn > syn_sf
# END SYN SF
# ---------------------------------------------------------------------------------
...
# BEGIN SYN DC
# 从标准输入中读取格林函数
grt static syn -S1e24 -M33/50/120 -N < grn > syn_dc
# END SYN DC
# ---------------------------------------------------------------------------------
...
# BEGIN SYN DC2
# 从标准输入中读取格林函数
grt static syn -S1e24 -M33/90/0 -N < grn > syn_dc2
# END SYN DC2
# ---------------------------------------------------------------------------------
...
# BEGIN SYN MT
# 从标准输入中读取格林函数
grt static syn -S1e24 -T0.1/-0.2/1.0/0.3/-0.5/-2.0 -N < grn > syn_mt
# END SYN MT
# ---------------------------------------------------------------------------------
...
# BEGIN SYN MT2
# 从标准输入中读取格林函数
grt static syn -S1e24 -T0/-0.2/0/0/0/0 -N < grn > syn_mt2
# END SYN MT2
# ---------------------------------------------------------------------------------
