...
dists = [5,8,10]
pymod.greenfn(depsrc=depsrc, deprcv=deprcv, dists=dists, nt=500, dt=0.02, statsidxs=[50,100])
# END DGRN
# -------------------------------------------------------------------
...
pymod.greenfn(depsrc=depsrc, deprcv=deprcv, dists=dists, nt=500, dt=0.02, converg_method='none', statsidxs=[50,100])
