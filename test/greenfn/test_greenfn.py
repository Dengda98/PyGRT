...
pymod.compute_grn(
    depsrc=depsrc, deprcv=deprcv, dists=dist, nt=nt, dt=dt, Length=20,
)
pymod.compute_grn(
    depsrc=depsrc, deprcv=deprcv, dists=dist, nt=nt, dt=dt,
...
pymod.compute_grn(
    depsrc=depsrc, deprcv=0.0, dists=2000, nt=1400, dt=1.0, safilonTol=1e-3,
)
pymod.compute_grn(
    depsrc=depsrc, deprcv=0.0, dists=2000, nt=1400, dt=1.0,
