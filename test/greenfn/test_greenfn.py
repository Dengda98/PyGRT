...
stgrn = pymod.compute_grn(dist, nt, dt, Length=20, converg_method='DCM')[0]
stgrn = pymod.compute_grn(dist, nt, dt, Length=20, converg_method='PTAM')[0]
stgrn = pymod.compute_grn(dist, nt, dt, Length=20, converg_method='none')[0]
