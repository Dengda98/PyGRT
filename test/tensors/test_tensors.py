...
pymod.compute_syn(dist=dist, azimuth=az, scale=1e20, output_path="syn", calc_upar=True)
pygrt.utils.compute_strain("syn")
pygrt.utils.compute_stress("syn")
pygrt.utils.compute_rotation("syn")

pymod.compute_syn(dist=dist, azimuth=az, scale=1e20, output_path="syn_zne", zne=True, calc_upar=True)
...
pymod_s.compute_static_grn(depsrc=2.0, deprcv=0.0, norths=[-3.0, 3.0, 1.0], easts=[-2.0, 2.0, 1.0], calc_upar=True)
pymod_s.compute_static_syn(scale=1e20, output_path="stsyn.nc", calc_upar=True)
pygrt.utils.compute_strain("stsyn.nc")
pygrt.utils.compute_stress("stsyn.nc")
pygrt.utils.compute_rotation("stsyn.nc")

pymod_s.compute_static_syn(scale=1e20, output_path="stsyn_zne.nc", zne=True, calc_upar=True)
...
pymod_s.compute_static_syn(scale=1e20, output_path="stsyn_q.nc", recv_points=rcv, calc_upar=True)
